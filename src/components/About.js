    ...
    <Grid container direction="column">
      ...
      <Grid item container justifyContent="center" className={classes.rowContainer}>
        <Typography variant="h4" align="center" className={classes.statement}>
          ...
          about in the best way possible. Dancah Technology, will use that
      ...
      >
        ...
        >
          ...
          <Grid item style={{ textAlign: smallest ? "center" : "justifyContent" }}>
            ...
            <Typography variant="body1" paragraph>
              Founded in 2024, we’re ready to get our hands on the world’s
              business problems.
            </Typography>
            <Typography variant="body1" paragraph>
      ...
      >
        ...
        >
          ...
          <Grid item style={{ marginTop: "2rem", textAlign: "center" }}>
            <Typography variant="h4">Kang`ethe Muthunga</Typography>
          ...
          >
            <Typography variant="body1" paragraph>
              My journey with computers began through my brother in high school.
              Captivated by how they function, I pursued Information Technology.
              During my first semester, I coded ‘Hello World’ using HTML and
              CSS, breathing life into a webpage—planting a seed. Today, that
              passion thrives as I constantly learn: computing, math,
              philosophy, and design, embracing lifelong growth.
            </Typography>
            <Typography variant="body1" paragraph>
